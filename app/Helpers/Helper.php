...
class Helper
{
    ...
    {
        return CompanySetting::first()->light_logo ?? asset('assets/img/logo/logo.webp');
    }
    public static function getLogoDark()
    {
        return CompanySetting::first()->dark_logo ?? asset('assets/img/logo/logo.webp');
    }
    public static function getFavicon()
    {
        return CompanySetting::first()->favicon ?? asset('assets/img/favicon/favicon.webp');
    }
