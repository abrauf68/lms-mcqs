                ...
                <div class="dropdown me-3">
                    ...
                    <div class="dropdown-menu mt-2 min-w-auto shadow" aria-labelledby="dropdownLanguage">
                        <a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
                                src="{{ ('frontAssets/images/flags/uk.svg') }}" alt="">English</a>
                        <a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
                                src="{{ ('frontAssets/images/flags/sp.svg') }}" alt="">Español</a>
                        <a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
                                src="{{ ('frontAssets/images/flags/fr.svg') }}" alt="">Français</a>
                        <a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
                                src="{{ ('frontAssets/images/flags/gr.svg') }}" alt="">Deutsch</a>
                    </div>
                </div>
    ...
    <nav class="navbar navbar-expand-xl">
        <div class="container">
            ...
            <a class="navbar-brand me-0" href="{{ route('frontend.home') }}">
                <img class="light-mode-item navbar-brand-item" src="{{ asset(\App\Helpers\Helper::getLogoLight()) }}" alt="logo">
                ...
                <ul class="navbar-nav navbar-nav-scroll mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="pagesMenu" data-bs-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">For Businesses</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="pagesMenu" data-bs-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">Partner with us</a>
                        <ul class="dropdown-menu" aria-labelledby="pagesMenu">
                    ...
                    <div class="dropdown-menu dropdown-menu-end shadow rounded p-2" aria-labelledby="navSearch"
                        ...
                        <ul class="list-group list-group-borderless p-2 small">
                            ...
                            <li class="list-group-item text-primary-hover text-truncate">
                                <a href="#" class="text-body"> <i class="far fa-clock me-1"></i>Digital
                                    marketing course for Beginner</a>
                            </li>
                            <li class="list-group-item text-primary-hover text-truncate">
                                <a href="#" class="text-body"> <i class="far fa-clock me-1"></i>Customer Life
                                    cycle</a>
                            </li>
                            <li class="list-group-item text-primary-hover text-truncate">
                                <a href="#" class="text-body"> <i class="far fa-clock me-1"></i>What is
                                    Search</a>
                            </li>
                            <li class="list-group-item text-primary-hover text-truncate">
                                <a href="#" class="text-body"> <i class="far fa-clock me-1"></i>Facebook
                                    ADS</a>
                            </li>
                        </ul>
                    </div> --}}
