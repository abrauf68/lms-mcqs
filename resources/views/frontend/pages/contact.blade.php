...
@section('content')
    ...
    <section class="pt-5 pb-0"
        style="background-image:url({{ asset('frontAssets/images/element/map.svg') }}); background-position: center left; background-size: cover;">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row g-4 g-md-5 justify-content-between">
                ...
                <div class="col-lg-6 mb-5 mb-lg-0">
                    ...
                    <p class="mb-5">
                        Experience our platform firsthand with a 1-hour live demo designed to showcase how we can empower
                        your learning journey. See the tools, features, and strategies that have helped thousands of
                    ...
                    <ul class="list-group list-group-borderless mt-3 mb-sm-5">
                        <li class="list-group-item h6 fw-light d-flex">
                            <i class="fas fa-check-circle fa-fw text-success me-2"></i>
                            A comprehensive overview of the platform and its features
                        </li>
                        <li class="list-group-item h6 fw-light d-flex">
                            <i class="fas fa-check-circle fa-fw text-success me-2"></i>
                            Real-life success stories and results from our learners
                        </li>
                        <li class="list-group-item h6 fw-light d-flex">
                            <i class="fas fa-check-circle fa-fw text-success me-2"></i>
                            Hands-on demonstration of actionable learning tools
                        </li>
                        <li class="list-group-item h6 fw-light d-flex">
                            <i class="fas fa-check-circle fa-fw text-success me-2"></i>
                            Clear communication with no information gaps
                        </li>
                        <li class="list-group-item h6 fw-light d-flex">
                            <i class="fas fa-check-circle fa-fw text-success me-2"></i>
                            Effective solutions for group-level challenges
                        </li>
                        <li class="list-group-item h6 fw-light d-flex">
                            <i class="fas fa-check-circle fa-fw text-success me-2"></i>
                            Unlimited access to over 5,000 courses and resources
                        </li>
                    </ul>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="tiny-slider arrow-round">
                                <div class="tiny-slider-inner" data-arrow="false" data-dots="false" data-gutter="80"
                                    ...
                                    <!-- Slide item START -->
                                    <div class="item"> <img class="grayscale"
                                            src="{{ asset('frontAssets/images/client/coca-cola.svg') }}" alt="">
                                    </div>
                                    <div class="item"> <img class="grayscale"
                                            src="{{ asset('frontAssets/images/client/android.svg') }}" alt="">
                                    </div>
                                    <div class="item"> <img class="grayscale"
                                            src="{{ asset('frontAssets/images/client/envato.svg') }}" alt=""> </div>
                                    <div class="item"> <img class="grayscale"
                                            src="{{ asset('frontAssets/images/client/microsoft.svg') }}" alt="">
                                    </div>
                                    <div class="item"> <img class="grayscale"
                                            src="{{ asset('frontAssets/images/client/netflix.svg') }}" alt="">
                                    </div>
                                    <div class="item"> <img class="grayscale"
                                            src="{{ asset('frontAssets/images/client/google.svg') }}" alt="">
                                    </div>
                                    <div class="item"> <img class="grayscale"
                                            src="{{ asset('frontAssets/images/client/linkedin.svg') }}" alt="">
                                    </div>
                                    <!-- Slide item END -->
                                </div>
                            </div>
                ...
                <div class="col-lg-6 mb-5">
                    <div class="bg-dark rounded-3 p-4 p-sm-5 position-relative">
                        ...
                        <figure class="position-absolute top-0 start-50 translate-middle w-100 mt-n1">
                            <svg enable-background="new 0 0 420.7 53.6" version="1.1" viewBox="0 0 420.7 53.6"
                        ...
                        <figure class="w-100 position-absolute top-100 start-50 translate-middle">
                            <svg enable-background="new 0 0 607.7 74.6" version="1.1" viewBox="0 0 607.7 74.6"
                                xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                                <path class="fill-dark"
                        ...
                        <form class="row g-3 position-relative">
                            ...
                            <!-- Last name -->
                            <div class="col-md-6 bg-dark-input">
                                <label class="form-label text-white text-opacity-50">Last name <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 bg-dark-input">
                                <label class="form-label text-white text-opacity-50">
                                    I'm interested in <span class="text-danger">*</span>
                                </label>
                                <select class="form-select" name="interest">
                                    ...
                                    <option value="Enterprise upskilling">Enterprise upskilling</option>
                            ...
                            <div class="col-md-6 bg-dark-input">
                                <label class="form-label text-white text-opacity-50">
                                    How did you find us? <span class="text-danger">*</span>
                                </label>
                            ...
                            <div class="col-12 bg-dark-input">
                                ...
                                <textarea class="form-control" rows="3" placeholder="We want to hear from you." name="message"></textarea>
                            </div>
