        ...
        <div class="container">
            <div class="row g-4 g-md-5 justify-content-between">
                ...
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <!-- Title -->
                    <h1>Try Demo</h1>
                    <p class="mb-5">Get a sneak peek at our top-tier exam prep products—designed in a flexible online
                        format so you can study anytime, anywhere! The demos on this page offer a quick preview of our
                        resources, helping you see how they work on your device and fit into your study routine.</p>

                    <!-- Sub tittle -->
                    <h4 class="mb-3">Available demos include:</h4>
                    <!-- List -->
                    <ul class="list-group list-group-borderless mt-3 mb-sm-5">
                        <li class="list-group-item h6 fw-light d-flex"><i
                                class="fas fa-check-circle fa-fw text-success me-2"></i>Exam Prep Guides</li>
                        <li class="list-group-item h6 fw-light d-flex"><i
                                class="fas fa-check-circle fa-fw text-success me-2"></i>Hot Topics Flashcards</li>
                        <li class="list-group-item h6 fw-light d-flex"><i
                                class="fas fa-check-circle fa-fw text-success me-2"></i>And More!</li>
                    </ul>
                    <!-- Sub tittle -->
                    <h4 class="mb-3">Getting started is easy:</h4>
                    <!-- List -->
                    <ul class="list-group list-group-borderless mt-3 mb-sm-5">
                        <li class="list-group-item h6 fw-light d-flex"><i
                                class="fas fa-check-circle fa-fw text-success me-2"></i>Select a product from the form on
                            the left.</li>
                        <li class="list-group-item h6 fw-light d-flex"><i
                                class="fas fa-check-circle fa-fw text-success me-2"></i>A demo description will appear here.
                        </li>
                        <li class="list-group-item h6 fw-light d-flex"><i
                                class="fas fa-check-circle fa-fw text-success me-2"></i>When you're ready, enter your name
                            and email, then click LAUNCH DEMO to begin!</li>
                    </ul>

                    <p class="mb-5">Project Management Professional (PMP)®, Certified Associate in Project Management
                        (CAPM)® and PMI Agile Certified Practitioner (PMI-ACP)® are registered trademarks of the Project
                ...
                <div class="col-lg-6 mb-5">
                    <div class="bg-dark rounded-3 p-4 p-sm-5 position-relative">
                        ...
                        <!-- Form START -->
                        <form id="demoForm" action="{{ route('frontend.submit.demo') }}" class="row g-3 position-relative" method="POST">
                            @csrf
                            <div class="col-12 bg-dark-input">
                                <label class="form-label">Select a Product <span class="text-danger">*</span></label>
                                <select name="product_id" class="form-select js-choice" aria-label=".form-select-sm">
                            ...
                            <div class="col-12 bg-dark-input">
                                <div class="d-grid">
                                    <button type="button" id="launchDemoBtn" class="btn btn-lg btn-primary">
                                        Launch Demo
                                    </button>
                                </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Thanks for Trying the PM FASTrack® Cloud Demo</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>

                <div class="modal-body">
                    <p>
                        On the next page, you will be launched directly into a brief exam simulation of 25 questions.
                    </p>

                    <p>
                        While taking the test, you can explore the kinds of questions the database contains.
                    </p>

                    <p>
                        After your demo, you may review your answers and explanations.
                    </p>

                    <p>
                        Your demo test data and score are stored temporarily and will disappear at the end of your session.
                    </p>

                    <p>
                        If you have questions, contact options are available at the CONTACT US link.
                    </p>
                </div>

                <div class="modal-footer d-flex justify-content-between">
                    <button type="button" class="btn btn-success" id="startDemoBtn">
                        START DEMO
                    </button>
...
@section('script')
    <script>
        document.getElementById("launchDemoBtn").addEventListener("click", function() {
            ...
            let productInput = document.querySelector('[name="product_id"]');
            ...
            function showError(input, message) {
                ...
                error.className = "text-danger small error-msg";
            ...
            // ✅ If valid → open modal
            if (isValid) {
                let modal = new bootstrap.Modal(document.getElementById('demoModal'));
                modal.show();
            }
        });
